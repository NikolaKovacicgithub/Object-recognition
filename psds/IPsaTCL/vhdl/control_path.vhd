...
signal area_reg, area_next: integer;              -- Povr ina konture
...
type point_type is record
    x: std_logic_vector(x_reg'range);  -- Kori�cenje istog ranga kao x_reg
    y: std_logic_vector(y_reg'range);
end record;

type stack_array_type is array(0 to 10000) of point_type;
signal stack: stack_array_type;

signal visited_reg, visited_next : std_logic_vector((61 * 61) - 1 downto 0);

signal cx, cy: std_logic_vector(5 downto 0);
...
signal pixel_addr_reg, pixel_addr_next: std_logic_vector(16 downto 0);
signal mask_addr_reg, mask_addr_next: std_logic_vector(16 downto 0);
...
signal width, width_next : integer;
...
signal rows_reg, rows_next : std_logic_vector(5 downto 0);
signal cols_reg, cols_next : std_logic_vector(5 downto 0);
...
process(allWhite_reg, objects_count_reg, min_x_reg, max_x_reg, min_y_reg, max_y_reg, mask_reg, bram1_indata, bram2_indata, pixel_mask_reg, current_state,rows_reg, cols_reg, lower_reg, upper_reg, start, lower_in, upper_in, bram1_indata, x_reg, y_reg, rows_in, cols_in, i_reg, j_reg, visited_reg, pixel_addr_reg, pixel_reg, mask_addr_reg, newY_reg, newX_reg, cx_reg, cy_reg, area_reg)
  begin
