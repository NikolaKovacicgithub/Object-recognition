...
HD_PWD='C:/Users/nikol/Downloads/ee77/y24-g07/psds/project_1/result/control_project/control_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log control_path.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source control_path.tcl -notrace
